...
python ../code/downscale_hourly.py fit \
    --era5-nc  ../data/raw/era5/era5_india_2025_hourly.nc \
    --gcm-grid   ../data/proc/CanESM5/tas_CanESM5_historical_bc.nc \
